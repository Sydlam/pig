...
expName = 'bps2'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/sydneylambert/Desktop/pig/mrs-m/experiment/ses-2_run-3_bps2_lastrun.py',
...
trials = data.TrialHandler(nReps=1.0, method='sequential', 
    ...
    trialList=data.importConditions(f'data/{bidsID}/{bidsID}_ses-2_task-bps2_events-input.csv'),
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if mem_resp.status == STARTED and not waitOnFlip:
            theseKeys = mem_resp.getKeys(keyList=['1', '2', '3', '4'], waitRelease=False)
    ...
    while continueRoutine and routineTimer.getTime() < 0.5:
        ...
        if '1' in mem_resp.keys: 
            def_old2_col = 'darkgray'
            maybe_old2_col = 'white'
            maybe_new2_col = 'white'
            def_new2_col = 'white'
        elif '2' in mem_resp.keys:
            def_old2_col = 'white'
            maybe_old2_col = 'darkgray'
            maybe_new2_col = 'white'
            def_new2_col = 'white'
        elif '3' in mem_resp.keys:
            def_old2_col = 'white'
            maybe_old2_col = 'white'
            maybe_new2_col = 'darkgray'
            def_new2_col = 'white'
        elif '4' in mem_resp.keys:
            def_old2_col = 'white'
            maybe_old2_col = 'white'
            maybe_new2_col = 'white'
...
try:
    ...
    cols_to_drop = [
        'bps2_trials.thisRepN',
        'bps2_trials.thisTrialN',
        'bps2_trials.thisN',
        'bps2_trials.thisIndex'
    ]
