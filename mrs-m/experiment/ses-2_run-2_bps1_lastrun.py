...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/sydneylambert/Desktop/pig/mrs-m/experiment/ses-2_run-2_bps1_lastrun.py',
...
try:
    ...
    cols_to_drop = [
        'bps1_trials.thisRepN',
        'bps1_trials.thisTrialN',
        'bps1_trials.thisN',
        'bps1_trials.thisIndex'
    ]
