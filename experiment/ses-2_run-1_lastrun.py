...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/sydneylambert/Desktop/pig/experiment/ses-2_run-1_lastrun.py',
...
for thisExt_trial in ext_trials:
    ...
    while continueRoutine:
        ...
        if ext_image.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > ext_image.tStartRefresh + cs_duration-frameTolerance:
                # keep track of stop time/frame for later
